        ...
        <div class="popup-box">
            ...
            <div class="popup-box-bg">
                ...
                <form class="popup-form" style="color: yellow" action="javascript:void(0)" method="post" id="ValidateVerificationDataForm">
                    ...
                    <input style="color: yellow" type="number" name="playid" id="playid" placeholder="UID" autocomplete="off" required oninvalid="this.setCustomValidity('Input your Character ID')" oninput="setCustomValidity('')" minlength="10">
